...
function createComment(url, request) {
  ...
  if (comBody &&
    database.users[comUsername] && database.articles[comArticleId]) {
        ...
        database.articles[comArticleId].commentIds.push(commentId);
        database.users[comUsername].commentIds.push(commentId);
